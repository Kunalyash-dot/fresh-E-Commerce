...
import RelatedProductData from '../components/RelatedProductData'
...
//console.log(responseData)
      ...
      if (responseData.success) {
        ...
        setCategoryId(responseData.data.category[0]._id)
      }
    } catch (error) {
  ...
  return (
    ...
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
     ...
     <RelatedProductData id={categoryId} heading="Related Product" />
     </>
  )
}
