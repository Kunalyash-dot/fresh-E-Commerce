            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
              <div className='grid gap-1'>
                ...
                <input
                  ...
                  required
                  className='bg-blue-50 p-2 outline-none border focus-within:border-pink-300 rounded'
                />
              </div>
              <div className='grid gap-1'>
                ...
                <textarea
                  ...
                  multiple
                  rows={3}
                  className='bg-blue-50 p-2 outline-none border focus-within:border-pink-300 rounded resize-none'
                />
              </div>
              <div>
              ...
              <div onClick={() => setOpenAddField(true)} className=' hover:bg-green-200 bg-green-100 py-1 px-3 w-32 text-center font-semibold border border-green-300 hover:text-neutral-900 cursor-pointer rounded'>
                Add Fields
              </div>

              <button
                className='bg-yellow-200 hover:bg-yellow-300 py-2 rounded font-semibold'
              >
                Update Product
              </button>
            </form>
