...
function AddFieldComponent({close,value,onChange,submit}) {
  return (
    ...
    <div className='bg-white rounded p-4 w-full max-w-md'>
        ...
        <input
             className='bg-blue-50 my-3 p-2 border outline-none focus-within:border-black rounded w-full '
        ...
        <button
            onClick={submit}
            className='bg-green-200 hover:bg-green-300 px-4 py-2 rounded mx-auto w-fit block'
        >Add Field</button>
    </div>
</section>
  )
